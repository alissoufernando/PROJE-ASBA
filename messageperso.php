...
<div class="profil" id="profil"> <center>Pee-Com</center>
</div>
<section id="sectiongauche" style="background:#fff;padding:10px;">
...
<p id="p1" style="color:red"> <?php echo $donnees['date'];?> </p></a>
</div>
<?php
}
$reponse->closeCursor();
...
<div align="center" class="cadre1" style="padding:10px;overflow:auto;">
<div id="partit">
...
<form action="messageprive2.php" method="post" style="margin-top: 20px;" id="answers">
        <textarea name="reponse" id="reponse"></textarea><br><br>
...
}, 100000); // on exécute le chargement toutes les 5 secondes
} charger();
</script>
