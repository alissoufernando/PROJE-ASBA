...
<?php
$_SESSION['identifiant'] = $_COOKIE['id'];
?>
...
{
?>
        <div class="divdereponde"><div style="float: right;margin-right: 20px;text-align: justify;width:;font-family: Century Schoolbook;font-size: 17;" class="messa"><?php echo $donnees['reponse'];?></div>
